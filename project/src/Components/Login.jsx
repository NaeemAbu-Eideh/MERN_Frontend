            ...
            <div
                ...
                <div className="w-full md:w-1/2 bg-white p-10 md:p-14 flex flex-col justify-center">
                    <div className="flex mb-8">
                        <button
                            type="button"
                            className="w-1/2 pb-2 text-center text-blue-600 font-bold border-b-2 border-blue-600"
                        >
                            LOGIN
                        </button>
                        <Link
                            to="/register"
                            className="w-1/2 pb-2 text-center text-gray-400 font-semibold border-b border-gray-200 hover:text-gray-600"
                        >
                            REGISTER
                        </Link>
                    </div>
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#1A5CFF] hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 transition duration-300 mb-6"
                        >
                            LOGIN
                        </button>
                    </form>
