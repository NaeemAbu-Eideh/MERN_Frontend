...
export default function Tournaments() {
    return (
        <div className="p-8 max-w-7xl mx-auto font-sans text-gray-800">
            ...
            <div
                className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4 mb-6 items-center">
                ...
                <select
                    className="w-full md:w-48 py-3 px-4 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none bg-white">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="w-64">
                    <select
                        className="w-full py-2 px-4 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none bg-white">
