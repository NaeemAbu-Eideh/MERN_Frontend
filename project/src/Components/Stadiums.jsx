...
// بيانات وهمية للملاعب بناءً على الصورة
const stadiumsData = [
  {
    id: 1,
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto font-sans text-gray-800">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <select className="w-full py-2.5 px-4 border border-gray-200 rounded-lg text-sm text-gray-600 focus:outline-none bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {stadiumsData.map((stadium) => (
          <div key={stadium.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div className="p-6">
                ...
                <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="bg-green-100 text-green-600 text-xs font-bold px-3 py-1 rounded-full border border-green-200">
                        {stadium.status}
                    </span>
                </div>
